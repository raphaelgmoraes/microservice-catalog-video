...
#[AllowDynamicProperties] class DeleteCategoryUseCaseUnitTest extends TestCase
{
    public function test_delete()
    {
        ...
        $this->mockRepositoryInterface->shouldReceive('delete')->andReturn(true);

        $this->mockInputDto = Mockery::mock(CategoryInputDto::class, [$uuid]);

        $useCase = new DeleteCategoryUseCase($this->mockRepositoryInterface);
    ...
    public function test_delete_false()
    {
        ...
        $this->mockRepositoryInterface = Mockery::mock(stdClass::class, CategoryRepositoryInterface::class);
        $this->mockRepositoryInterface->shouldReceive('delete')->andReturn(false);
